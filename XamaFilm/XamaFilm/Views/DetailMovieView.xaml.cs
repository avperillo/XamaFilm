...
namespace XamaFilm.Views
{
	...
	public partial class DetailMovieView : ContentPage
	{
		...
		public DetailMovieView()
		{
            ...
            imageImage.Source = movie.Poster;
            descriptionLabel.Text = movie.Genre;
            actorsLabel.Text = movie.Actors;
            wirtersLabel.Text = movie.Writer;
            countryLabel.Text = movie.Country;
            rewardsLabel.Text = movie.Awards;
            ratingsList.ItemsSource = movie.Ratings;
